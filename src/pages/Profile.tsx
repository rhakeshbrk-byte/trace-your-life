import { Shield, Brain, ChevronRight, LogOut, ChevronDown } from "lucide-react";
...
const Profile = () => {
  ...
  return (
    <div className="px-4 pt-4 pb-4 max-w-lg mx-auto">
      ...
      <AccordionSection icon={Shield} title="Privacy Controls" color="accent" delay="100ms">
      ...
      <AccordionSection icon={Brain} title="AI Settings" color="secondary" delay="200ms">
