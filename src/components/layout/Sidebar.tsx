...
const Sidebar = ({ onPostClick }: SidebarProps) => {
  ...
  return (
    <aside
      data-testid="sidebar"
      className="hidden md:flex flex-col w-64 shrink-0 h-screen sticky top-0 z-40 border-r border-white/[0.06]"
      style={{
    ...
    >
      ...
      <div className="p-6 pb-4">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-xl overflow-hidden shrink-0 btn-glow">
            <img
